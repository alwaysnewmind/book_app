          ...
          builder: (context, writer, _) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final canEdit = writer.canEditBook(book: book, user: currentUser);
                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: book.isPremium ? const Color(0xFFF5C84C) : const Color(0xFF251A3F),
                                      borderRadius: BorderRadius.circular(10),
                                      border: Border.all(
                                        color: book.isPremium ? const Color(0xFFE6B93E) : const Color(0xFF3A2D5C),
                                      ),
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        color: book.isPremium ? const Color(0xFF1F1533) : const Color(0xFFCFC8E8),
                                        fontSize: 11,
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
                              ...
                              Row(
                                ...
                                children: [
                                  _ActionIcon(
                                    ...
                                    onTap: canEdit
                                        ? () {
                                            Navigator.pushNamed(context, AppRoutes.createBookEntry, arguments: {'bookId': book.id});
                                          }
                                        : () {
                                            showAppPopup(
                                              context: context,
